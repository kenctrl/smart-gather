...
if __name__ == "__main__":
    ...
    for example in examples:
        ...
        if SAVE_MAPPING:
            ...
            if example['type'] == GPT_JOIN:
                baseline_filename = PICKLE_PATH + example['category'] + '_baseline_gpt_join.pickle'
                with open(baseline_filename, 'wb') as f:
                    pickle.dump(example['expected_joins'], f)

            if example['type'] == GPT_HEADER_GPT_JOIN:
                baseline_filename = PICKLE_PATH + example['category'] + '_baseline_gpt_header_gpt_join.pickle'
                with open(baseline_filename, 'wb') as f:
                    pickle.dump(example['gpt_mapping'], f)
