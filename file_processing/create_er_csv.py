...
def create_er_csv(schema_headers, best_url, column_mapping, max_rows=50):
    """
    ...
    print(f"\nCSV file with requested headers has been created at {output_filename}.")

def generate_smart_data(schema_headers, scraped_url_file):
    """
    ...
    create_er_csv(schema_headers, best_url, all_metrics[best_url]['column_mapping'])
...
if __name__ == '__main__':
    ...
    generate_smart_data(schema_headers, scrape_results)
